// tailwind.config.js - Royalti.io Brand Configuration
const config = {
  content: [
    './pages/**/*.{ts,tsx}',
    './components/**/*.{ts,tsx}',
...
// styles/globals.css - Add Red Hat font and custom CSS variables
...
@layer utilities {
  .text-gradient {
    @apply bg-gradient-to-r from-royal-600 via-royal-500 to-royal-400 bg-clip-text text-transparent;
  }
