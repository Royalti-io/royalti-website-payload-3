// Import the base Block type from payload
import type { Block } from 'payload'

// Define an extended Block type that includes the admin.preview property
...
export const MainHeroBlock: ExtendedBlock = {
  slug: 'mainHero',
  labels: {
    singular: 'Main Hero',
    plural: 'Main Heroes',
...
export const SecondaryHeroBlock: ExtendedBlock = {
  slug: 'secondaryHero',
  labels: {
...
// Product Hero Block
export const ProductHeroBlock: ExtendedBlock = {
  slug: 'productHero',
  labels: {
